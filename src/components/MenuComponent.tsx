...
export function MenuComponent({ menu, other }) {
      ...
      <div className="flex flex-row flex-wrap gap-2 p-4 sm:col-span-2 lg:col-span-3 2xl:col-span-4 sm:pt-28">
        {sandwichIsView && (
          <>
            ...
            {menu.map((item, index) => (
              <div
                className="flex min-w-[18rem] flex-1 flex-col items-center justify-start gap-2 rounded-xl border border-zinc-700 bg-zinc-800 p-6"
                key={index}
              >
          ...
          <>
            ...
            </div>
            {
				other.map((item, index) => (
					<div className="flex min-w-[18rem] flex-1 flex-col items-center justify-start gap-2 rounded-xl border border-gray-700 bg-gray-800 p-6" key={index}>
						<div className="flex h-[200px] w-[200px] items-center justify-center rounded-xl bg-white">
							{item.img !== '' ? (
								<img src={item?.img} alt="Food" width={200} height={200}/>
							) : (
